...
<head>
    ...
    <title>Home | eCare Education</title>
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 01688496756</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> saqlaincse@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="https://www.facebook.com/saqlain.cse/"><i class="fa fa-facebook"></i></a></li>
								<li><a href="https://www.linkedin.com/in/saqlain-cse/"><i class="fa fa-linkedin"></i></a></li>
								<li><a href="https://github.com/SaqlainCSE"><i class="fa fa-github"></i></a></li>
								<li><a href="https://www.instagram.com/saqlain_mustak56/"><i class="fa fa-instagram"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<h2> <a href="/" style="color: orange;"> eCare Education </a1> </h2>
						</div>
			...
			<div class="row">
							...
							?>
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title"><a href="{{URL::to('/product_by_category/'.$data->category_id)}}">{{$data->category_name}}</a></h4>
										</div>
									</div>
							...
							<div class="brands-name">
								...
								<?php
									$all_published_manufacture = DB::table('manufactures')
										...
										{
								?>
									<li><a href="{{URL::to('/product_by_manufacture/'.$data->manufacture_id)}}"> <span class="pull-right"></span>{{$data->manufacture_name}}</a></li>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						@yield('content')	<!--from home_content.blade.php-->
	...
	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<h2><span>eCare</span> Education</h2>
							<p>A online educational plateform</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<div class="address">
							...
							<p>505 East Khilgaon, Dhaka-1219 (Bangladesh)</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2021 eCare Education All rights reserved.</p>
					<p class="pull-right">Developed by <span><a target="_blank" href="http://www.facebook.com/saqlain.cse">Saqlain Mustak</a></span></p>
				</div>
			</div>
		</div>
