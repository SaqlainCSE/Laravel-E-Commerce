							...
							<div class="product-image-wrapper">
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										...
										<li><a href="{{URL::to('/view_product/'.$data->product_id)}}"><i class="fa fa-plus-square"></i>View</a></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tshirt" data-toggle="tab">IT & Software</a></li>
								<li><a href="#blazers" data-toggle="tab">Business</a></li>
								<li><a href="#sunglass" data-toggle="tab">Development</a></li>
								<li><a href="#kids" data-toggle="tab">Marketing</a></li>
								<li><a href="#poloshirt" data-toggle="tab">Machine Learning</a></li>
							</ul>
						</div>
