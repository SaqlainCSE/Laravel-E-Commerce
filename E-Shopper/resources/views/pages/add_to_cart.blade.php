					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="{{URL::to($data->options->image)}}" height="80px" width="80px" alt=""></a>
							</td>
							...
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="{{URL::to('/delete-to-cart/'.$data->rowId)}}"><i class="fa fa-times"></i></a>
							</td>
						</tr>
